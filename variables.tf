...
variable "services_hub_cidr_block" {
    type = string
    default = "192.168.100.0/24"
}
variable "spoke_a_cidr_block" {
    type = string
    default = "192.168.101.0/24"
}
variable "spoke_b_cidr_block" {
    type = string
...
variable "spoke_b_subnet_cidr" {
    type = string
    default = "192.168.102.0/25"
}
variable "onprem_subnet_cidr" {
    type = string
    default = "172.16.100.0/25"
}
variable "spokes_summary_cidr" {
    type = string
...
variable "remote_state_shared_spoke_a_path" {
    type = string
}
